...
public class PDFCreator {
    ...
    public void createPdf(String dest, String username, String mark, String model, String fuel, double yearProduction,
        ...
        table1.addCell(mark + ", " + model +  ", " + carType + ", " + fuel+ ", " + df1.format(yearProduction));
        table1.addCell(df2.format(price) + " PLN");
        doc.add(table1);
        ...
        table2.addHeaderCell(df2.format(price) + " PLN");
        table2.addCell("");
        table2.addCell("NET");
        table2.addCell(df2.format(price-(price*0.23)) + " PLN");
        table2.addCell("");
        table2.addCell("IN TOTAL:").setBold();
        table2.addCell(df2.format(price) + " PLN").setBold();
        doc.add(table2);
        Paragraph paragraph2 = new Paragraph(new Text("\n"));
        doc.add(paragraph2);
        Text thanks = new Text("Thank you for your trust\nand cooperation!").setFontSize(20).setItalic();
